...
public struct P50_ProgressView: View {
    ...
    public var body: some View {
        ZStack {
            ...
            FabulaSheet(isOpen: $isOpen) {
                Text("Progress Value").modifier(FabulaSectionModifier())
                FabulaSlider(value: $progress, title: "progress", min: 0, max: 1)
...
struct P50_ProgressView_Previews: PreviewProvider {
