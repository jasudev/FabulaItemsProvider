...
public struct P9_RightSheet: View {
...
#endif
            .frame(maxWidth: 500)
            .padding(.trailing, minArea)
            
            GeometryReader { proxy in
                RightSheet(isOpen: $isOpen, constants: constants) {
                    DummyView(direction: .vertical)
                }
            }
        }
    }
...
struct P9_RightSheet_Previews: PreviewProvider {
